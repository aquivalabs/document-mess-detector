...
The App is also available as [free app on the AppExchange](https://appexchange.salesforce.com/appxListingDetail?listingId=8ae56cbd-8b6b-4009-bf17-1781d9416fe8) and as Open Source repository on Github.
...
Clone the repo, test it in a Scratch org using `scripts/create-scratch-org.sh` and then create your own Unlocked or Managed Package from it. All the steps, how to configure and use the app can be found in the [User Guide (PDF)](user-guide.pdf).
